...
export default function Home() {
  ...
  return (
    <>
      ...
      <div style={{
        minHeight:'100vh',
        background:'radial-gradient(1200px 600px at 10% 10%, rgba(56,189,248,.08), transparent 40%), radial-gradient(1000px 500px at 90% 20%, rgba(99,102,241,.10), transparent 42%), linear-gradient(180deg, #0b1220 0%, #0b1220 100%)',
        color:'#e2e8f0',
            ...
            <div style={{border:'1px solid #1f2937',borderRadius:12,padding:16,background:'#0f172a'}}>
              ...
              <textarea
                ...
                style={{
                  ...
                  border:'1px solid #1f2937', borderRadius:12, padding:'10px 12px',
                  resize:'none'  // ⛔ запрет ручного изменения размера
                }}
              />
              <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:10, marginTop:10}}>
                <button
                  onClick={()=>{ setGeneratedSql('SELECT * FROM customers LIMIT 10;') /* заглушка */}}
