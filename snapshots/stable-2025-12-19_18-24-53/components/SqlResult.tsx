  ...
  return (
    <div style={{ display: "grid", gap: 12, marginTop: 16 }}>
      {danger && (
        ...
        >
          <b style={{ color: "#ffb4b4" }}>ВНИМАНИЕ:</b> Запрос содержит
          потенциально опасные операции (
          <b>
            DROP/ALTER/TRUNCATE/CREATE/GRANT/REVOKE/DELETE/UPDATE/INSERT/MERGE
          </b>
      ...
      {/* Обычный вариант */}
      <Block
        title="Обычный вариант"
        code={variantPlain}
        onCopy={() => copy(variantPlain)}
      />
